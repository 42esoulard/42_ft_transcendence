...
export declare class ChannelMembersService {
    ...
    createChannelMember(channel: Channels, user: Users, is_owner?: boolean, is_admin?: boolean, notification?: boolean): Promise<ChannelMembers>;
    deleteChannelMember(cm_id: number): Promise<DeleteResult>;
    toggleAdmin(cm_id: number): Promise<ChannelMembers>;
    muteBanMember(action: string, cm_id: number, end_date: number): Promise<ChannelMembers>;
