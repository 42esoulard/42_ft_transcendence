...
let ChannelMembersService = class ChannelMembersService {
    ...
    async createChannelMember(channel, user, is_owner = false, is_admin = false, notification = false) {
        return await this.channelMembersRepository
            .save({
            channel: channel,
            member: user,
            ...
            .catch(() => {
            throw new common_1.BadRequestException('Channel Member did not comply database requirements');
        });
    }
...
ChannelMembersService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(channel_members_entity_1.ChannelMembers)),
