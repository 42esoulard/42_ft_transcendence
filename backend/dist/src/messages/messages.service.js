...
let MessagesService = class MessagesService {
    constructor(messagesRepository, channelService, channelMemberService, userService) {
    ...
    async saveMessage(messageDto) {
        ...
        newMessage.author = await this.userService.getUserbyId(messageDto.author_id);
        newMessage.channel = await this.channelService.getChannelById(messageDto.channel_id, messageDto.author_id);
        ...
        await this.channelMemberService
            ...
            if (newMessage.channel.messages.length > 50) {
                await this.messagesRepository
                    ...
                    .catch(() => {
                    throw new common_1.BadRequestException('Failed to purge messages from db');
                });
            }
        });
        return await this.messagesRepository
            ...
            .catch(() => {
            throw new common_1.BadRequestException('Message did not comply database requirements');
        });
    }
};
