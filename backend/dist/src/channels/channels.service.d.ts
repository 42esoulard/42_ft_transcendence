...
export declare class ChannelsService {
    ...
    constructor(channelsRepository: Repository<Channels>, userService: UsersService, channelMemberService: ChannelMembersService, relationshipService: RelationshipsService);
    ...
    filterBlocked(user: Users, userChannels: ChannelMember[]): Promise<ChannelMember[]>;
    ...
    checkPasswordMatch(channel_id: number, user_id: number, attempt: string): Promise<boolean>;
    ...
    muteBanMember(action: string, cm_id: number, end_date: number): Promise<ChannelMember>;
    toggleAdmin(cm_id: number): Promise<ChannelMember>;
    updateChannelPassword(chan_id: number, user_id: number, pwd: string): Promise<Channel>;
}
