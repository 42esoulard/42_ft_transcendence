...
class Channel {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, type: { required: true, type: () => String }, password: { required: true, type: () => String }, messages: { required: true, type: () => [require("../../messages/interfaces/message.interface").Message] }, channel_members: { required: true, type: () => [require("../../channel_members/interfaces/channel_member.interface").ChannelMember] }, created_at: { required: true, type: () => Date } };
    }
}
