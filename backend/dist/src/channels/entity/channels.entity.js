...
let Channels = class Channels {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, type: { required: true, type: () => String }, password: { required: true, type: () => String }, channel_members: { required: true, type: () => [require("../../channel_members/entity/channel_members.entity").ChannelMembers] }, messages: { required: true, type: () => [require("../../messages/entity/messages.entity").Messages] }, created_at: { required: true, type: () => Date } };
    }
};
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => channel_members_entity_1.ChannelMembers, (cm) => cm.channel, {
        cascade: true,
        eager: true,
        nullable: true,
    }),
    __metadata("design:type", Array)
], Channels.prototype, "channel_members", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => messages_entity_1.Messages, (message) => message.channel, {
        eager: true,
    }),
    __metadata("design:type", Array)
], Channels.prototype, "messages", void 0);
__decorate([
