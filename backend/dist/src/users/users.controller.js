...
let UsersController = class UsersController {
    ...
    async removeUser(id, request) {
        ...
        if (request.user.id != id) {
            ...
            if (reqUser && reqUser.role == 'user') {
                throw new common_1.ForbiddenException('not authorized to delete other users');
            }
        }
    ...
    async updateUser(updatedUser, request) {
        ...
        if (request.user.id != id) {
            const reqUser = await this.userService.getUserbyId(request.user.id);
            if (reqUser && reqUser.role == 'user') {
                throw new common_1.ForbiddenException('not authorized to update other users');
            }
        }
    ...
    async uploadFile(req, file) {
        ...
        if (!(await (0, files_upload_utils_1.IsFileExtensionSafe)(`./${file.path}`))) {
    ...
    getAvatar(filename, res) {
        const file = (0, fs_1.createReadStream)((0, path_1.join)('./uploads/avatars/', filename)).on('error', () => {
            res.sendStatus(404);
        });
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./interfaces/user.interface").User] }),
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getUsersLadder", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getBannedUsers", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "demoteUser", null);
__decorate([
    (0, roles_decorator_1.Roles)(role_enum_1.Role.OWNER),
    (0, common_1.UseGuards)(jwtTwoFactor_guard_1.JwtTwoFactorGuard, roles_guard_1.RolesGuard),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "changeOwner", null);
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("./interfaces/user.interface").User }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwtTwoFactor_guard_1.JwtTwoFactorGuard),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('avatar', files_upload_utils_1.saveImageToStorage)),
    openapi.ApiResponse({ status: 201 }),
