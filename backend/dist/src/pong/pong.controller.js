...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entity/games.entity").Game] }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PongController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PongController.prototype, "GetOnGoingGames", null);
__decorate([
    (0, common_1.Get)('/user-games/:id'),
    openapi.ApiResponse({ status: 200, type: [require("./entity/gameUser.entity").GameUser] }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], PongController.prototype, "getUserGameUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], PongController.prototype, "getGamebyId", null);
