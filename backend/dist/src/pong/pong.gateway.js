...
let PongGateway = class PongGateway {
    constructor(gameRepo, gameUserRepo) {
    ...
    async handleAskToPlay(client, message) {
        const newChallenge = new pong_challenge_1.challenge(message.challengerId, message.challengerName, message.challengeeId, message.challengeeName, message.expiry_date, message.gameMode);
    ...
    async handleAcceptChallenge(client, challengerName) {
        ...
        const player1 = new pong_player_1.player(challenge.challengeeId, challenge.challengeeName, client, 1);
        const player2 = new pong_player_1.player(challenge.challengerId, challenge.challengerName, challenge.challengerSocket, 2);
    ...
    async handleJoinGameMessage(client, message) {
        ...
        if (message.gameMode === 'classic') {
            if (!this.waitingPlayerClassic)
                ...
                const player2 = new pong_player_1.player(message.userId, message.userName, client, 2);
    ...
    addPlayerToQueue(client, message) {
        if (message.gameMode === 'classic')
            this.waitingPlayerClassic = new pong_player_1.player(message.userId, message.userName, client, 1);
        if (message.gameMode === 'transcendence')
            this.waitingPlayerTranscendence = new pong_player_1.player(message.userId, message.userName, client, 1);
    ...
    async createGame(player1, player2, gameMode) {
        const game = new pong_pongGame_1.pongGame(player1, player2, this.gameRepo, this.gameUserRepo, this.server, gameMode);
...
], PongGateway.prototype, "handleAskToPlay", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('cancelChallenge'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, String]),
    __metadata("design:returntype", Promise)
], PongGateway.prototype, "handleCancelChallenge", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('challengeAccepted'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, String]),
    __metadata("design:returntype", Promise)
], PongGateway.prototype, "handleAcceptChallenge", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('challengeDeclined'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, String]),
    __metadata("design:returntype", Promise)
], PongGateway.prototype, "handleDeclineChallenge", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('joinGame'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Object]),
    __metadata("design:returntype", Promise)
], PongGateway.prototype, "handleJoinGameMessage", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('watchGame'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, String]),
    __metadata("design:returntype", Promise)
], PongGateway.prototype, "handleWatchGame", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('leaveQueue'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket]),
    __metadata("design:returntype", void 0)
], PongGateway.prototype, "handleLeaveQueue", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [socket_io_1.Socket, String]),
    __metadata("design:returntype", void 0)
], PongGateway.prototype, "handleEnlargeRacquet", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('moveRacquet'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Object]),
    __metadata("design:returntype", void 0)
], PongGateway.prototype, "handleMoveRacquet", null);
