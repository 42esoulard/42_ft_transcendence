...
const gameStats_entity_1 = require("./entity/gameStats.entity");
...
PongModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([games_entity_1.Game, gameStats_entity_1.GameStats, users_entity_1.Users, gameUser_entity_1.GameUser]),
