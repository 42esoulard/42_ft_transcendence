...
export declare class AuthController {
    ...
    turnOnTwoFactorAuthentication(request: Request, { code: twoFACode }: TwoFactorDto): Promise<{
        message: string;
    }>;
    turnOffTwoFactorAuthentication(request: Request): Promise<{
        message: string;
    }>;
    authenticate(request: Request, { code: twoFACode }: TwoFactorDto): Promise<User>;
}
