...
let FortyTwoStrategy = class FortyTwoStrategy extends (0, passport_1.PassportStrategy)(passport_42_1.Strategy, 'FortyTwoStrategy') {
    ...
    async validate(accessToken, refreshToken, profile, cb) {
        ...
        const userProfile = { username, photo };
