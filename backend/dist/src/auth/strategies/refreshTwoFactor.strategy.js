...
let RefreshTwoFactorStrategy = class RefreshTwoFactorStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'refresh-two-factor') {
    ...
    async validate(req, payload) {
        ...
        const cookie = req === null || req === void 0 ? void 0 : req.cookies['tokens'];
        if (!(cookie === null || cookie === void 0 ? void 0 : cookie.refresh_token)) {
