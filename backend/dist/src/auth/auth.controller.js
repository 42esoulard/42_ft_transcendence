...
let AuthController = class AuthController {
    ...
    async turnOnTwoFactorAuthentication(request, { code: twoFACode }) {
        const isCodeValid = this.authService.isTwoFACodeValid(twoFACode, request.user);
        if (!isCodeValid) {
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: require("../users/interfaces/user.interface").User }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "getKey", null);
__decorate([
    (0, swagger_1.ApiCookieAuth)(),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("../users/interfaces/user.interface").User }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, TwoFactor_dto_1.TwoFactorDto]),
