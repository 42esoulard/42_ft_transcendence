...
export declare class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    handleNewFriendshipRequest(client: Socket, relationship: Relationship, requester: string): void;
    handleNewBlocked(client: Socket, relationship: Relationship, requester: string): void;
    handleRemoveBlocked(client: Socket, requester: User, adresseeId: number): void;
    acceptFriendship(client: Socket, user1Id: number, user1Name: string, user2Id: number, user2Name: string): void;
