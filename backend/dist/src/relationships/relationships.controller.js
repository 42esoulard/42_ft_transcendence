...
let RelationshipsController = class RelationshipsController {
    ...
    async saveRelationship(newRelationship) {
        const user1 = await this.userService.getUserbyId(newRelationship.requesterId);
        if (!user1)
            throw new common_1.BadRequestException("user doesn't exist");
    ...
    async validateRelationship(toMajRelationship) {
        const relationship = await this.relationshipService.getRelationship(toMajRelationship.requesterId, toMajRelationship.adresseeId);
        return await this.relationshipService.validateRelationship(relationship);
    }
    async removeRelationship(toRemoveRelationship) {
        const relationship = await this.relationshipService.getRelationship(toRemoveRelationship.userId1, toRemoveRelationship.userId2);
        if (!relationship)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "getPendingRelationships", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "getAllUserFriendships", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "getUserBlocked", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "getBlockedByUser", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseGuards)(jwtTwoFactor_guard_1.JwtTwoFactorGuard),
    openapi.ApiResponse({ status: 201, type: require("./interfaces/relationship.interface").Relationship }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [createRelationship_dto_1.CreateRelationshipDto]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "saveRelationship", null);
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [validateRelationship_dto_1.ValidateRelationshipDto]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "validateRelationship", null);
__decorate([
    (0, common_1.Delete)(),
    (0, common_1.UseGuards)(jwtTwoFactor_guard_1.JwtTwoFactorGuard),
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [removeRelationship_dto_1.RemoveRelationshipDto]),
    __metadata("design:returntype", Promise)
], RelationshipsController.prototype, "removeRelationship", null);
