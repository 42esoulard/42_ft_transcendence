...
export declare class RelationshipsService {
    ...
    saveRelationship(relationshipDto: CreateRelationshipDto): Promise<Relationship>;
    validateRelationship(relationship: Relationship): Promise<import("typeorm").UpdateResult>;
    removeRelationship(relationshipDto: RemoveRelationshipDto): Promise<import("typeorm").DeleteResult>;
}
