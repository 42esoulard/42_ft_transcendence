...
export declare class RelationshipsController {
    ...
    saveRelationship(newRelationship: CreateRelationshipDto): Promise<Relationship>;
    validateRelationship(toMajRelationship: ValidateRelationshipDto): Promise<import("typeorm").UpdateResult>;
    removeRelationship(toRemoveRelationship: RemoveRelationshipDto): Promise<import("typeorm").DeleteResult>;
}
