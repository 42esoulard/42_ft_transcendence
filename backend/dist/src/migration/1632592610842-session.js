...
class session1632592610842 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "type_orm_session" ("expiredAt" bigint NOT NULL, "id" character varying(255) NOT NULL, "json" text NOT NULL, CONSTRAINT "PK_1a98d1dcb141c81690d991f1e5d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4e605661de8a51f343e2889ac4" ON "type_orm_session" ("expiredAt") `);
