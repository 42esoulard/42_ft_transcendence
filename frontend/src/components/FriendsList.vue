...
<div class="list-div">
  ...
  <div class="list-div-panel">
    <ul class="list-div-panel__list">
      <li v-for="relationship in relationships" :key="relationship.created_at" class="friend-name">
        <router-link class="link link--neutral" :to="{ name: 'UserProfile', params: {username: friendName(relationship)} }">
