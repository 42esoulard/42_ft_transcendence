<template>
  ...
  <div class='chat-channel-form'>
    ...
    <form class="chat-channel-form__form" @submit.prevent='checkPassword()'>
      <div class="chat-channel-form__title">[{{ channel.name }}] is a password-protected community.</div>
      <div class="chat-channel-form__subtitle">To join, please enter the channel's password:</div>

      <input class="chat-channel-form__input" required type="text" name='password' placeholder='Channel Password' minlength="1" v-model="passwordAttempt" @input="reinitError()">
